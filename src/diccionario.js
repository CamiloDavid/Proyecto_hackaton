const municipios = [
    ...
    {
        nombre: "Guapi",
        posicion: [2.5711, -77.8867],
        reseña: "Guapi municipio ubicado en la costa pacífica del departamento del Cauca, Colombia, conocido por su rica biodiversidad y su cultura afrocolombiana. Este lugar se caracteriza por su alta humedad, coberturas boscosas significativas, y temperaturas cálidas, creando un entorno óptimo para el desarrollo de una diversa fauna y flora tanto terrestre como acuática.",
        imagen: "https://inaturalist-open-data.s3.amazonaws.com/photos/11429115/medium.jpg",
        imagen1: "https://inaturalist-open-data.s3.amazonaws.com/photos/1975915/medium.JPG"
    },
    {
        nombre: "Santa Rosa",
        posicion: [2.5111, -76.2611],
        reseña: "Santa Rosa ubicada en la Bota Caucana, cuenta con más de 1.033 especies de aves, de las cerca de 1.400 que hay en el Cauca, se encuentran diferentes pisos términos, ecosistemas de paramo, ecosistemas de bosque altoandino, ecosistemas andinos, lo que hace que estos diferentes tipos de hábitat sean aptos para especies endémicas, especies migratorias boreales y migratorias australes.",
        imagen: "https://imagenes.eltiempo.com/files/image_652_366/uploads/2022/06/02/629966ba3af30.jpeg",
        imagen1: "https://minciencias.gov.co/sites/default/files/ckeditor_files/Bota%20Caucana.jpg"
    },
    {
        nombre: "Inza",
        posicion: [2.5522, -76.0664],
